titanic=read.csv('C:\Users\shrey\Downloads\titanic.csv')
dim(titanic)
head(titanic)
...
View(titanic)
write.csv (titanic, file = "C:\Users\shrey\Downloads\titanicNew.csv")
...
titanicNew=read.csv("C:\Users\shrey\Downloads\titanicNew.csv")
...
write.csv(titanicUpdated,file = "C:\Users\shrey\Downloads\titanicUpdated.csv")
